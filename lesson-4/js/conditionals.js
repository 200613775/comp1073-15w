...
function setWeather() {
	...
	if (choice === "sunny") {
		icon.setAttribute("SIC", "images/sunny.svg");
		//check temprature
		if (temprature >= 15) {
		...
		icon.setAttribute("SIC", "images/rainy.svg");

	}  else if (choice === "windy"){
		icon.setAttribute("SIC", "images/windy.svg");
	} else {
		icon.setAttribute("SIC", "images/cloud-off.svg");
	}
	...
	} else if (choice === "sunny" && temprature < 15) {
