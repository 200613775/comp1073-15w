...
const person = {
    ...
    age: 18,
    gender: "female",
    intrests: ["Dancing", "Travelling", "business"],
    greeting() {
        let greeting =`Hi, My name is ${this.name.first} and I am ${this.age}years old. One of my intrests is ${this.intrests[1]}`;
        return greeting;
    }
};
...
person.goodbye = function() {
    let ggodbye = `${this.name.first} says goodbye!`;
    return goodbye;
}
