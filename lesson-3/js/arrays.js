...
output.textContent = `There are ${myArray[3].length} iteams in the array inside the myArray array.`;
output.textContent = "";
// In particular, looping through arrays
for (let i = 0; i < myArray.length; i ++){
    //check if array element is array
...
let orig6 = `Torronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montreal Canadiens, New York Rangers`;
...
orig6Array.splice(2, 2, "Edmomton Olivers");
