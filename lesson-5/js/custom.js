...
btn.onClick = function() {
    ...
    let msgPanelColor = displayMessage(`This is fatal error.`, "error");
...
function displayMessage() {
    ...
    msgPanel.textContent = "Alert message";
    ...
    let msgPanelColor = document.getComputedStyle(msgPanel).getPropertyValue("background-color");
